...
import mainnaro from '../images/main-naro.jpg';
...
const Home = () => {
 const [openSection, setOpenSection] = useState(null); // NEW
  ...
  return (
    <div className="naro-background">

      {/* Header Section */}
      <div className="naro-subbackground">
        <div className="naro-bluebackground">
          <div className="naro-info">
            <h1>WE'RE THE LAST OF BREED.</h1>
            <p>Achieve your Dream Style</p><br />
            <div className='home-botton'>
              <a className='home-buttontext' href="#">Book Now</a>
            </div>
          </div>
          <div className="main-naro">
            <img src={mainnaro} alt="Main Naro" />
          </div>
        </div>
      </div><br /><br />
        ...
        <div className="pricing-listing">
          ...
          {services.map((service, index) => (
            <div className="pricing-item" key={index}>
              <span>{service}</span>
              <span className="price-amount">From <strong>$40</strong></span>
            </div>
          ))}
        </div>
      </div>
